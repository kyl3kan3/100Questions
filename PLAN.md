...
- Packages are $9 for an introductory first benchmark, $15 for later single benchmarks,
  $39 for three, and $99 for ten. A signed paid Checkout Session grants the package's fixed
