...
export function buildSitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: absoluteUrl("/ai-brand-risk-checker"),
      lastModified: augustSixteenth,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: absoluteUrl("/llms-txt-checker"),
      lastModified: augustSixteenth,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    ...
    {
      url: absoluteUrl("/customer-research-methods"),
      lastModified: augustSixteenth,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: absoluteUrl("/can-google-alerts-track-chatgpt-mentions"),
      lastModified: augustSixteenth,
      changeFrequency: "monthly",
      priority: 0.85,
    },
