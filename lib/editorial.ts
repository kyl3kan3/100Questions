...
export const EDITORIAL_AUTHOR = {
  ...
  description:
    "Kyle builds and maintains 100 Questions and reviews its public measurement methodology, product documentation, and evidence-led AI visibility guides.",
  areas: [
...
export function buildEditorialPersonStructuredData() {
  return {
    ...
    sameAs: [EDITORIAL_AUTHOR.githubUrl],
